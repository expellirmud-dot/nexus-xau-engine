# Phase 1 Exness Archive Annual Validation - 2021

Status: DONE / VALIDATOR V0.2 / YEAR-BATCH RECONCILED
Date: 2026-09-15
Durable job: `XAU-EXNESS-YEAR-2021-V02-20260915`
Runner revision: `f416a75`

Coverage-selected months: all 12 months.
All 12 completed with `VALIDATED` structural status.

Observed totals:
- ZIP bytes: 209,062,838
- tick rows: 22,103,256
- provider mismatch: 0
- symbol mismatch: 0
- Ask < Bid: 0
...
Interpretation:
2021 acquisition/structural validation is complete for every month classified AVAILABLE by the coverage map.
The unresolved 2016 March/April boundary gap candidate remains preserved separately.

Next bounded action:
Run the same durable annual procedure for 2022, then reconcile its manifest/anomaly evidence before 2023.
