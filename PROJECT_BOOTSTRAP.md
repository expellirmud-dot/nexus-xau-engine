...
4. Read the files reported by preflight, at minimum:
...
5. Read any additional current checkpoint/source files named by `docs/CURRENT_RESEARCH_STATE.json -> research_loop.load_order` when they are material to the active question.
